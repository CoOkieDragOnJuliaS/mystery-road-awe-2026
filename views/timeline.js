...
import { findLocationById, findEvidenceById, formatDate } from "../utils/lookupHelpers.js";
...
export function openEvidenceModal(evidenceId) {
  ...
  console.log("modal opened, active close listeners:", state.getModalCloseListenerCount());
